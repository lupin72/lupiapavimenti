...
if ( !function_exists( "cl_add_single_portfolio_metaboxes" ) ):
    function cl_add_single_portfolio_metaboxes($metaboxes) {
        ...
        $page_style = array(
            ...
            'fields'        => array(
                array(
                    ...
                    'type' => 'switch',
                    'title' => __('Overwrite the link with your custom link', 'codeless'),
                ...
                array(
                    ...
                    'type' => 'slides',
                    'title' => __('Add/Edit Slides', 'codeless'),
                    'subtitle' => __('Add new or edit existing slider images', 'codeless'),
                ...
                array(
                    ...
                    'type' => 'switch',
                    'title' => __('Switch On if you want comments functionality', 'codeless'),
                    'default' => 0// 1 = on | 0 = off
                ),
        ...
        $custom_fields = array(
            'title'         => __('Custom Fields', 'codeless'),
            'icon_class'    => 'icon-large',
            'icon'          => 'el-icon-home',
            'fields'        => array(
                array(
                    ...
                    'type' => 'multi_text',
                    'title' => __('Custom fields Values', 'codeless'),
                    'subtitle' => __('Create unlimited custom fields in Theme Options. Leave empty if you dont want to display this custom field', 'codeless').'<br /><br />Fields:<br />'.trim($description_fields)
                ),
...
if ( !function_exists( "cl_add_portfolio_metaboxes" ) ):
    function cl_add_portfolio_metaboxes($metaboxes) {
        ...
        $portfolio_options[] = array(
            //'title'         => __('General Settings', 'codeless'),
            'icon_class'    => 'icon-large',
            'icon'          => 'el-icon-home',
            'fields'        => array(
                array(
...
if ( !function_exists( "cl_add_layout_metaboxes" ) ):
    function cl_add_layout_metaboxes($metaboxes) {
        ...
        $layoutOptions = array();
        $layoutOptions[] = array(
            //'title' => __('Home Settings', 'codeless'),
            'icon_class' => 'icon-large',
            'icon' => 'el-icon-home',
            'fields' => array(
                array(
                    'id' => 'overwrite_layout',
                    'type' => 'switch',
                    'title' => __('Overwrite the default post layout', 'codeless'),
                    'subtitle' => __('Do you want to overwrite the default layout for this post?', 'codeless'),
                    'default' => 0// 1 = on | 0 = off
                ),
                array(
                ...
                array(
                    ...
                    'type' => 'select',
                    'title' => __('Left Sidebar', 'codeless'),
                ...
                array(
                    ...
                    'type' => 'select',
                    'title' => __('Right Sidebar', 'codeless'),
                    'subtitle' => __('', 'codeless'),
                    'data' => 'sidebar',
                    'required' => array('layout','=','dual')
                ),
        ...
        $metaboxes[] = array(
            'id' => 'demo-layout2',
            //'title' => __('Cool Options', 'codeless'),
...
if ( !function_exists( "cl_add_general_metaboxes" ) ):
    function cl_add_general_metaboxes($metaboxes) {
        ...
        $page_header_section = array(
            'title' => __('Page Header Options', 'codeless'),
            'desc' => __('In this section you can create custom page header only for this page. If you want to change or to view the default page header options', 'codeless').' <a href="'.admin_url().'admin.php?page=_options&tab=2">click here</a>',
            'icon' => 'el-icon-home',
            'fields' => array(  
                            ...
                            array(
                                ...
                                'type' => 'switch',
                                'title' => __('Overwrite the default page options', 'codeless'),
                                'subtitle' => __('Do you want to overwrite the default page options in Theme Options ?', 'codeless'),
                                'default' => 0// 1 = on | 0 = off
                            ),
                            ...
                            array(
                                'id' => 'subtitle_bool',
                                'type' => 'switch',
                                'title' => __('SUbtitle for this page ?', 'codeless'),
                                'default' => 0,
                                'required' => array('page_header_overwrite','=','1')
                            ),
                            ...
                            array(
                                ...
                                'type' => 'text',
                                'title' => __('SUbtitle for this page', 'codeless'),
                                'subtitle' => __('Add a subtitle here', 'codeless'),
                                'desc' => __('Show after the main title  ', 'codeless'),
        ...
        $slider_section = array(
            ...
            'title' => __('Sliders Options', 'codeless'),
            'icon' => 'el-icon-home',
            'fields' => array(
                            array(
                                'id' => 'slider_type',
                                'type' => 'select',
                                'title' => __('Select Slider Type', 'codeless'),
                                'subtitle' => __('Select one of the listed sliders', 'codeless'),
                            ...
                            array(
                                'id' => 'gallery_effect',
                                'type' => 'select',
                                'title' => __('Gallery Carousel Effect', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                                'default' => 'simple',
                            ...
                            array( 
                                'id' => 'revslider',
                                'type' => 'select',
                                'title' => __('Select one of the created revolution sliders.', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                            ...
                            array(
                                'id' => 'layerslider',
                                'type' => 'select',
                                'title' => __('Select one of the created layer sliders.', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                            ...
                            array(
                                'id' => 'codeless_slider',
                                'type' => 'select',
                                'title' => __('Select one of the created codelessliders.', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                                'data' => 'categories',
                            ...
                            array(
                                ...
                                'type' => 'text',
                                'title' => __('Codeless Slider Speed', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                                'default' => '800',
                                'required' => array('slider_type', '=', 'codeless' )
                            ),
                            ...
                            array(
                                ...
                                'type' => 'text',
                                'title' => __('Slider height', 'codeless'),
                                'subtitle' => __('Write 100% for fullscreen or for example 600 (without px) for custom', 'codeless'),
                            ...
                            array(
                                ...
                                'type' => 'select',
                                'title' => __('Select the first featured post', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                                'data' => 'post',
                            ...
                            array(
                                ...
                                'type' => 'select',
                                'title' => __('Select the second featured post', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                                'data' => 'post',
                                'args' => array('orderby'=>'date', 'posts_per_page' => -1),
                                'required' => array('slider_type', '=', 'codeless_news')
                            ...
                            array(
                                'id' => 'slider_layout',
                                'type' => 'select',
                                'title' => __('Select Slider layout', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                            ...
                            array(
                                'id' => 'slider_fixed',
                                'type' => 'switch',
                                'title' => __('Active Fixed Slider', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                                'default' =>  0,
                                'required' => array('slider_type', '!=', 'none')
                            ),  
                            ...
                            array(
                                'id'=>'slider_parallax',
                                'type' => 'switch', 
                                'title' => __('Active Parallax', 'codeless'),
                                'subtitle'=> __('Look, it\'s on!', 'codeless'),
                                "default"       => 0,
                            ), 
                            ...
                            array(
                                ...
                                'type' => 'switch', 
                                'title' => __('Remove Sliders from Mobile Phone View', 'codeless'),
                                'subtitle'=> __('Check this option if you want to remove sliders from mobile view for this page.', 'codeless'),
                                "default"       => 0,
                            ),     
            )
        ...
        $page_opt_style = array(
            ...
            'title' => __('Page Options & Style', 'codeless'),
            'icon' => 'el-icon-home',
            'fields' => array(
                            array(
                                ...
                                'title' => __('Page Content Background', 'codeless'),
                                'subtitle' => __('Background color of content in this page ' , 'codeless'), 
                            ...
                            array(
                                ...
                                'type' => 'select',
                                'title' => __('Header Color Style for Header 1', 'codeless'),
                                'subtitle' => __('Select Light for light colors in header and white logo', 'codeless'),
                            ...
                            array(
                                'id' => 'one_page_active', 
                                'type' => 'switch',
                                'title' => __('Use menu as one page menu', 'codeless'),
                                'subtitle' => __('Check this to activate one page menu', 'codeless'),
                                'desc' => __('After activate this, to the sections of visual composer add a class attribute for ex: "services" and set the link of the menu item: #services', 'codeless'),
                                'default' => '0'// 1 = on | 0 = off
                            ),
                            ...
                            array(
                                ...
                                'type' => 'switch',
                                'title' => __('Fullscreen Sections Sliding', 'codeless'),
                                'subtitle' => __('Check to use visual sections as fullscreen sections', 'codeless'),
                                'desc' => __('', 'codeless'),
                                'default' => '0'// 1 = on | 0 = off
                            ),
                            ...
                            array(
                                ...
                                'type' => 'switch', 
                                'title' => __('Use Featured Image as Photo', 'codeless'),
                                'subtitle'=> __('', 'codeless'),
                                "default"       => 1,
                            )
        ...
        $blog_options[] = array(
            ...
            'fields'        => array(
                ...
                array(
                    ...
                    'type' => 'text',
                    'title' => __('Fullscreen Post Effect Delay', 'codeless'),
                    'default' => '200'
                ),
                array(
