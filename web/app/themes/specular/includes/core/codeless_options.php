...
if ( ! class_exists( 'Redux' ) ) {
    ...
    $args = array(
                ...
                'menu_title' => __('Specular', 'codeless'),
                'page_title' => __('Specular', 'codeless'),
            ...
            if (!isset($args['global_variable']) || $args['global_variable'] !== false) {
                ...
                $args['intro_text'] = sprintf('<p>'.__('Codeless has been quietly but consistently building a powerhouse portfolio of web site design and marketing success.', 'codeless').' </p>', $v);
            } else {
                $args['intro_text'] = '<p>'.__('Codeless has been quietly but consistently building a powerhouse portfolio of web site design and marketing success. ', 'codeless').'</p>';
            }

            // Add content after the form.
            $args['footer_text'] = __('', 'codeless');
            ...
            Redux::setSection( $opt_name, array(
                'title' => __('General Options', 'codeless'),
                'desc' => __('In this section you can customize basic options like logo, responsive etc...', 'codeless'),
                'icon' => 'el-icon-cogs',
                ...
                'fields' => array(
                    ...
                    array(
                        'id' => 'responsive_bool',
                        'type' => 'switch',
                        'title' => __('Responsive Layout', 'codeless'),
                        'subtitle' => __('Switch on to active responsive layout', 'codeless'),
                        "default" => 1,
                    ),
                    ...
                    array(
                        'id' => 'logo_light',
                        'type' => 'media',
                        'title' => __('Upload Logo Light', 'codeless'),
                        'desc' => __('Upload here the logo that is placed in top of the page (Light Version) ', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                    ...
                    array(
                        ...
                        'width' => false,
                        'title' => __('Logo Height', 'codeless'),
                        'subtitle' => __('units: px', 'codeless'),
                        'desc' => __('', 'codeless'),
                    ...
                    array(
                        'id' => 'favicon',
                        'type' => 'media',
                        'title' => __('Favicon for your website', 'codeless'),
                        'desc' => __('', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                    ...
                    array(
                        'id' => 'nicescroll',
                        'type' => 'switch',
                        'title' => __('Smooth Scroll', 'codeless'),
                        'subtitle' => __('Switch on to active smooth scrolling', 'codeless'),
                        "default" => 0,
                    ),
                    ...
                    array(
                        ...
                        'type' => 'section',
                        'title' => __('Select Special Pages', 'codeless'),
                    ...
                    array(
                        ...
                        'data' => 'pages',
                        'default' => '0',
                        'title' => __('Select Frontpage', 'codeless'),
                        'subtitle' => __('Frontpage is the page that you want to show in the home', 'codeless'),
                        'desc' => __('Select one of the created pages to use it as frontpage', 'codeless'),
                    ),
                    ...
                    array(
                        ...
                        'data' => 'pages',
                        'default' => '0',
                        'title' => __('Select Blog Page', 'codeless'),
                        'subtitle' => __('Blogpage is the page that you want to show the blog posts', 'codeless'),
                        'desc' => __('Select one of the created pages to use as blog', 'codeless'),
                    ),
                    ...
                    array(
                        ...
                        'data' => 'pages',
                        'default' => '0',
                        'title' => __('Select Coming Soon Page', 'codeless'),
                        'subtitle' => __('Select one page that you want to use as comingsoon or maintenance page', 'codeless'),
                        'desc' => __('', 'codeless'),
                    ),
                    ...
                    array(
                        ...
                        'type' => 'editor',
                        'title' => __('404 error message', 'codeless'),
                        'subtitle' => __('Text to be placed in 404 page', 'codeless'),
                    ...
                    array(
                        ...
                        'type' => 'section',
                        'title' => __('Tracking Code / Custom CSS / Custom JS', 'codeless'),
                        'indent' => true // Indent all options below until the next 'section' option is set.
                    ),
                    ...
                    array(
                        'id' => 'tracking_code',
                        'type' => 'ace_editor',
                        'title' => __('Tracking Code', 'codeless'),
                        'subtitle' => __('Paste your JS code here.', 'codeless'),
                        'mode' => 'javascript',
                        'theme' => 'chrome',
                    ...
                    array(
                        'id' => 'custom_css',
                        'type' => 'ace_editor',
                        'title' => __('Custom CSS Code', 'codeless'),
                        'subtitle' => __('Paste your CSS code here.', 'codeless'),
                        'mode' => 'css',
                        'theme' => 'monokai',
                    ...
                    array(
                        'id' => 'custom_js',
                        'type' => 'ace_editor',
                        'title' => __('Custom JS Code', 'codeless'),
                        'subtitle' => __('Paste your JS code here.', 'codeless'),
                        'mode' => 'text',
                        'theme' => 'chrome',
                        'desc' => '.',
            ...
            Redux::setSection( $opt_name, array(
                ...
                'title' => __('Header Options', 'codeless'),
                'fields' => array(
                    
                    array(
                        'id' => 'section-header-opts-start',
                        'type' => 'section',
                        'title' => __('General', 'codeless'),
                        'indent' => true // Indent all options below until the next 'section' option is set.
                    ),
                    ...
                    /*array(
                        'id' => 'header_presets',
                        'type' => 'image_select',
                        'title' => __('Header Predefined Styles', 'codeless'),
                        'presets'  => true,
                        'subtitle' => __('Select one of our predefined header styles and some options will change', 'codeless'),
                        'options' => array(
                            'h1' => array(
                                'alt' => 'Header 1', 
                                'img' => '',
                    ...
                    array(
                        'id' => 'header_style',
                        'type' => 'select',
                        'title' => __('Header Style', 'codeless'),
                        'subtitle' => __('Select the style for the header', 'codeless'),
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => __('Make Transparency Header', 'codeless'),
                    ...
                    array(
                        ...
                        'title' => __('Menu Overlay Fullscreen BG Color', 'codeless'),
                    ...
                    array(
                        ...
                        'title' => __('Header 6 Navigation BG Color', 'codeless'),
                        'mode' => 'background-color',  
                        'default'  => array(
                            'color' => '#000000', 
                            'alpha' => '1.00'
                    ...
                    array(
                        ...
                        //'units_extended' => 'true', // Allow users to select any type of unit
                        'width' => false,
                        'title' => __('Header 6 Navigation Height', 'codeless'),
                        'required' => array('header_style', 'equals', 'header_6'),
                        'subtitle' => __('units: px', 'codeless'),
                        'desc' => __('', 'codeless'),
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => __('Make transparent this header', 'codeless'),
                        'subtitle' => __('Switch On to enable transparency', 'codeless'),
                        'default' => 0,
                        'required' => array('header_style', 'equals', 'header_6'),
                    ),
                    ...
                    array(
                        ...
                        'width' => true,
                        'height' => false,
                        'title' => __('Header 7 Side Menu Width', 'codeless'),
                    ...
                    array(
                        ...
                        'title' => __('Header 7 Side Menu Inner Padding', 'codeless'),
                        'subtitle' => __('Adjust side menu padding ', 'codeless'),
                        'required' => array('header_style', 'equals', 'header_7'),
                        'desc' => __('Unit: px', 'codeless'),
                    ...
                    array( 
                        ...
                        //'units_extended' => 'true', // Allow users to select any type of unit
                        //'display_units' => 'false', // Set to false to hide the units if the units are specified
                        'title' => __('Header 7 Side Menu Inner Margin beetwen logo/menu/widgets', 'codeless'),
                        'subtitle' => __('Adjust margin beetween side menu elements logog/menu/widgets ', 'codeless'),
                        'required' => array('header_style', 'equals', 'header_7'),
                        'desc' => __('Unit: px', 'codeless'),
                    ...
                    array(
                        'title'     => __( 'Header 7 Side Menu Position', 'codeless' ),
                        'desc'      => __( 'Select the fixed position for the side navigation', 'codeless' ),
                    ...
                    array(
                        'id' => 'header_7_border', 
                        'type' => 'switch',
                        'title' => __('Add border to side header style', 'codeless'),
                        'subtitle' => __('Border for side left/right header style', 'codeless'),
                        'desc' => __('', 'codeless'),
                        'required' => array('header_style', 'equals', 'header_7'),
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => __('Add colored border in top of Header', 'codeless'),
                        'subtitle' => __('Border with theme color in top of Left/Right header', 'codeless'),
                        'desc' => __('', 'codeless'),
                        'required' => array('header_style', 'equals', 'header_7'),
                        'default' => 0// 1 = on | 0 = off
                    ),
                    ...
                    array(
                        'id' => 'header_10_border', 
                        'type' => 'switch',
                        'title' => __('Border Top & bottom for navigation', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        'desc' => __('', 'codeless'),
                    ...
                    array(
                        ...
                        //'units_extended' => 'true', // Allow users to select any type of unit
                        'width' => false,
                        'title' => __('Header Height', 'codeless'),
                        'subtitle' => __('units: px', 'codeless'),
                        'desc' => __('', 'codeless'),
                    ...
                    array(
                        ...
                        'title' => __('Background', 'codeless'),
                        'subtitle' => __('Header background with image, color, etc.', 'codeless'),
                        'default' => array(
                            'color' => '#fff',
                            'alpha' => '1.00'
                        ),
                    ...
                    array(
                        'id' => 'show_search', 
                        'type' => 'checkbox',
                        'title' => __('Show Search', 'codeless'),
                        'subtitle' => __('Show search in the right of header', 'codeless'),
                        'desc' => __('Check this if you want the search field in the right part of the header', 'codeless'),
                        'default' => '1'// 1 = on | 0 = off
                    ),
                    ...
                    array(
                        ...
                        'type' => 'checkbox',
                        'title' => __('Remove container from header', 'codeless'),
                        'subtitle' => __('Cant use with left menu', 'codeless'),
                        'desc' => __('By checking this the header container should be removed and transformed in fullwidth header', 'codeless'),
                        'default' => '0'// 1 = on | 0 = off
                    ),
                    ...
                    array(
                        'id' => 'show_button', 
                        'type' => 'checkbox',
                        'title' => __('Add button to header', 'codeless'),
                        'subtitle' => __('Add a button in header after the menu', 'codeless'),
                        'desc' => __('', 'codeless'),
                        'default' => '0'// 1 = on | 0 = off
                    ),
                    ...
                    array(
                        'id' => 'header_button',
                        'type' => 'text',
                        'title' => __('Header Button', 'codeless'),
                    ...
                    array(
                        ...
                        'type' => 'text', 
                        'title' => __('Header Button Link', 'codeless'),
                        'required' => array('show_button', 'equals', '1'),
                        'default' => '#'
                    ),
                    ...
                    array( 
                        ...
                        'type'     => 'border',
                        'title'    => __('Header Border Bottom', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        ...
                        'color'    => true,
                        'style'    => true,
                        'desc'     => __('Add Border bottom for header', 'codeless'),
                        'default'  => array(
                            'color'  => '', 
                            'border-style'  => 'solid',
                            'border-bottom'    => '0px'
                    ...
                    array(
                        'id' => 'header_shadow', 
                        'type' => 'select',
                        'title' => __('Header Shadow', 'codeless'),
                        'subtitle' => __('Select one shadow style or leave it without shadow', 'codeless'),
                        'desc' => __('Isnt compatible with all headers', 'codeless'),
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => __('Show Responsive Menu Dropdown', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        "default" => 1,
                    ),
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => __('Show header tools in responsive (Mobile)', 'codeless'),
                        'subtitle' => __('Extra Nav, Shop Cart etc...', 'codeless'),
                        "default" => 0,
                    ...
                    Redux::setSection( $opt_name, array(
                        'icon' => 'el-icon-website',
                        'title' => __('Menu Options', 'codeless'),
                        'fields' => array(
                            array(
                                'id' => 'menu_font_style',
                                'type' => 'typography',
                                'title' => __('Menu Item Typography', 'codeless'),
                                ...
                                'subtitle' => __('Select the appropiate font style for the menu', 'codeless'),
                                'default' => array(
                                    'color' => "#222",
                                    'font-weight' => '600',
                            ...
                            array(
                                ...
                                //'units_extended' => 'true', // Allow users to select any type of unit
                                //'display_units' => 'false', // Set to false to hide the units if the units are specified
                                'title' => __('Menu Items padding', 'codeless'),
                                'subtitle' => __('Adjust padding beetwen menu items ', 'codeless'),
                                'desc' => __('Unit: px', 'codeless'),
                            ...
                            array(
                                ...
                                //'units_extended' => 'true', // Allow users to select any type of unit
                                //'display_units' => 'false', // Set to false to hide the units if the units are specified
                                'title' => __('Menu Items Margin', 'codeless'),
                                'subtitle' => __('Adjust margin beetwen menu items ', 'codeless'),
                                'desc' => __('Unit: px', 'codeless'),
                    ...
                    Redux::setSection( $opt_name, array(
                        'icon' => 'el-icon-website',
                        'title' => __('Dropdown Options & Mobile Menu', 'codeless'),
                        'fields' => array(
                            array(
                                'id' => 'dropdown_width',
                                'type' => 'dimensions',
                                ...
                                //'units_extended' => 'true', // Allow users to select any type of unit
                                'height' => false,
                                'title' => __('Dropdown Width', 'codeless'),
                                'subtitle' => __('units: px', 'codeless'),
                                'desc' => __('', 'codeless'),
                            ...
                            array(
                                ...
                                'title' => __('Dropdown Background Color', 'codeless'),
                                'subtitle' => __('Background Color for the dropdown in the menu', 'codeless'),
                                'default' => '#222222'  
                            ),
                            ...
                            array(
                                ...
                                'title' => __('Dropdown Border color', 'codeless'),
                                'subtitle' => __('Dropdown border color for navigation', 'codeless'),
                                'default' => '#222222'
                            ),
                            ...
                            array( 
                                'id' => 'dropdown_font',
                                'type' => 'typography',
                                'title' => __('Dropdown typography', 'codeless'),
                                'font-family' => false,
                                ...
                                'text-transform' => true,
                                'units' => 'px', // Defaults to px
                                'subtitle' => __('Select the appropiate font style for the megamenu column title', 'codeless'),
                            ...
                            array( 
                                'id' => 'megamenu_title',
                                'type' => 'typography',
                                'title' => __('Megamenu title', 'codeless'),
                                'font-family' => false,
                                'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                                'font-backup' => false, // Select a backup non-google font in addition to a google font
                                'font-size'=>true,
                            ...
                            array(
                                ...
                                'type' => 'select',
                                'title' => __('Cart Dropdown in header button style', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                    ...
                    Redux::setSection( $opt_name, array(
                        'icon' => 'el-icon-website',
                        'title' => __('Top Widgetized Area', 'codeless'),
                        'fields' => array(
                            array(
                                'id' => 'top_navigation',
                                'type' => 'switch',
                                'title' => __('Show Top Navigation', 'codeless'),
                                'subtitle' => __('Switch On to enable top navigation', 'codeless'),
                                'default' => 0// 1 = on | 0 = off
                            ),
                            ...
                            array(
                                ...
                                'title' => __('Background Color', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                                'default' => '#f5f5f5',
                                'validate' => 'color',
                            ),
                            ...
                            array( 
                                ...
                                'type'     => 'border',
                                'title'    => __('Top Navigation Border Top', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                                'output'   => array('.top_nav'),
                                'right'    => false,
                                'bottom'   => false, 
                                ...
                                'color'    => true,
                                'style'    => true,
                                'desc'     => __('Add Border top for the top navigation', 'codeless'),
                                'default'  => array(
                                    'color'  => '', 
                                    'border-style'  => 'solid',
                                    'border-top'    => '0px',
                            ...
                            array( 
                                ...
                                'type'     => 'border',
                                'title'    => __('Top Navigation Border Bottom', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                                'output'   => array('.top_nav'),
                                'right'    => false,
                                'top'   => false, 
                                ...
                                'color'    => true,
                                'style'    => true,
                                'desc'     => __('Add Border bottom for the top navigation', 'codeless'),
                                'default'  => array(
                                    'color'  => '', 
                                    'border-style'  => 'solid',
                                    'border-bottom'    => '0px',
                            ...
                            array(
                                ...
                                'output' => array('.top_nav'),
                                'units' => 'px', // Defaults to px
                                'subtitle' => __('Select the appropiate font style for top nav', 'codeless'),
                                'default' => array(
                                    'color' => "#999",
                                    'font-family' => 'Open Sans',
                                    'google' => true,
                            ...
                            array(
                                ...
                                //'units_extended' => 'true', // Allow users to select any type of unit
                                'width' => false,
                                'title' => __('Top Nav Height', 'codeless'),
                                'subtitle' => __('units: px', 'codeless'),
                                'desc' => __('', 'codeless'),
                    ...
                    Redux::setSection( $opt_name, array(
                        'icon' => 'el-icon-website',
                        'title' => __('Default Page Header', 'codeless'),
                        'fields' => array(
                            array(
                                'id' => 'page_header_bool',
                                'type' => 'switch',
                                'title' => __('Active Page Header', 'codeless'),
                                'subtitle' => __('Switch On to enable page header for pages, posts (For each post or page you can add custom options)', 'codeless'),
                                'default' => 1// 1 = on | 0 = off
                            ),
                            ...
                            array(
                                ...
                                //'units_extended' => 'true', // Allow users to select any type of unit
                                'width' => false,
                                'title' => __('Page Header Height', 'codeless'),
                                'subtitle' => __('units: px', 'codeless'),
                                'desc' => __('', 'codeless'),
                                'default' => array('height' => 80)
                            ),
                            ...
                            array(
                                ...
                                'type' => 'select',
                                'title' => __('Page header style', 'codeless'),
                                'subtitle' => __('Select the style for the default page header', 'codeless'),
                            ...
                            array(
                                ...
                                'type' => 'color',
                                'output' => array('.header_page'),
                                'title' => __('Page header font color', 'codeless'),
                                'subtitle' => __('Select the color for the title or breadcrumbs in page header', 'codeless'),
                                'default' => '#444',
                                'validate' => 'color',
                            ),
                            ...
                            array(
                                ...
                                'type' => 'background',
                                'output' => array('.header_page'),
                                'title' => __('Page header background', 'codeless'),
                                'subtitle' => __('Page Header background with image, color, etc.', 'codeless'),
                            ...
                            array( 
                                ...
                                'type'     => 'border',
                                'title'    => __('Page header Border Bottom', 'codeless'),
                                'subtitle' => __('', 'codeless'),
                                ...
                                'color'    => true,
                                'style'    => true,
                                'desc'     => __('Add Border bottom for page header', 'codeless'),
                                'default'  => array(
                                    'color'  => '', 
                                    'border-style'  => 'solid',
                                    'border-bottom'    => '0px'
                    ...
                    Redux::setSection( $opt_name, array(
                        'icon' => 'el-icon-website',
                        'title' => __('Sticky Nav', 'codeless'),
                        'fields' => array(
                            array(
                                'id' => 'sticky',
                                'type' => 'switch',
                                'title' => __('Sticky Header', 'codeless'),
                                'subtitle' => __('Switch on to active sticky header (fixed position on header)', 'codeless'),
                                "default" => 0,
                            ),
                            array(
                                ...
                                //'units_extended' => 'true', // Allow users to select any type of unit
                                'width' => false,
                                'title' => __('Sticky Header Height', 'codeless'),
                                'subtitle' => __('units: px', 'codeless'),
                                'desc' => __('', 'codeless'),
                            ...
                            array(
                                ...
                                'title' => __('Sticky Background', 'codeless'),
                                'subtitle' => __('Header background with image, color, etc.', 'codeless'),
                                'default' => array(
                                    'color' => '#fff',
                                    'alpha' => '0.80'
                            ...
                            array(
                                'id' => 'sticky_logo',
                                'type' => 'switch',
                                'title' => __('Sticky Logo', 'codeless'),
                                'subtitle' => __('Remove the Logo from the main Header and shows only on stiky', 'codeless'),
                                "default" => 0,
            ...
            Redux::setSection( $opt_name, array(
                ...
                'title' => __('Styling Options', 'codeless'),
                'fields' => array(
                    array(
                        'id' => 'primary_color', 
                        'type' => 'color',
                        ...
                        'title' => __('Primary Color', 'codeless'),
                        'subtitle' => __('Color for links on hover, highlighted text and other', 'codeless'),
                        'default' => '#10b8c7',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        'id' => 'link_color', 
                        'type' => 'color',
                        'title' => __('Content Links Color', 'codeless'),
                        'subtitle' => __('Color for links', 'codeless'),
                        'default' => '#10b8c7',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'output' => array('body'),
                        'title' => __('Body Font Color', 'codeless'),
                        'subtitle' => __('Base font color for the main content, in light sections', 'codeless'),
                        'default' => '#777777',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'title' => __('Headings Font Color', 'codeless'),
                        'subtitle' => __('Base font color for headings, in light sections', 'codeless'),
                        'default' => '#444444',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'title' => __('Base Border Color', 'codeless'),
                        'subtitle' => __('Base border color around the theme', 'codeless'), 
                        'default' => '#e7e7e7',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'title' => __('Highlighted Background', 'codeless'),
                        'subtitle' => __('Highlighted Background in main content, white sections', 'codeless'), 
                        'mode' => 'background-color',
                        'default' => '#f5f5f5',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'title' => __('Background', 'codeless'),
                        'subtitle' => __('Add a background to body', 'codeless'),
                        'default' => 'transparent',
                    ),
                    ...
                    array(
                        ...
                        'title' => __('Content Background', 'codeless'),
                        'subtitle' => __('Add a background to content', 'codeless'),
                        'default' => 'transparent',
                    ),
            ...
            Redux::setSection( $opt_name, array(
                ...
                'fields' => array(
                        array( 
                            ...
                            'type' => 'typography',
                            'title' => __('Normal Style No Subtitle Title Typography', 'codeless'),
                            'font-family' => false,
                            'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                            'font-backup' => false, // Select a backup non-google font in addition to a google font
                            'font-size'=>true,
                        ...
                        array( 
                            ...
                            'type' => 'typography',
                            'title' => __('Normal Style With Subtitle Title Typography', 'codeless'),
                            'font-family' => false,
                            'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                            'font-backup' => false, // Select a backup non-google font in addition to a google font
                            'font-size'=>true,
                        ...
                        array( 
                            ...
                            'type' => 'typography',
                            'title' => __('Normal Style With Subtitle Subtitle Typography', 'codeless'),
                            'font-family' => false,
                            'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                            'font-backup' => false, // Select a backup non-google font in addition to a google font
                            'font-size'=>true,
                        ...
                        array( 
                            ...
                            'type' => 'typography',
                            'title' => __('Centered Style No Subtitle Title Typography', 'codeless'),
                            'font-family' => false,
                            'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                            'font-backup' => false, // Select a backup non-google font in addition to a google font
                            'font-size'=>true,
                        ...
                        array( 
                            ...
                            'type' => 'typography',
                            'title' => __('Centered Style With Subtitle Title Typography', 'codeless'),
                            'font-family' => false,
                            'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                            'font-backup' => false, // Select a backup non-google font in addition to a google font
                            'font-size'=>true,
                        ...
                        array( 
                            ...
                            'type' => 'typography',
                            'title' => __('Centered Style With Subtitle Subtitle Typography', 'codeless'),
                            'font-family' => false,
                            'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                            'font-backup' => false, // Select a backup non-google font in addition to a google font
                            'font-size'=>true,
                        ...
                        array(
                                ...
                                'type' => 'select',
                                'title' => __('Page Header Design Style', 'codeless'),
                                'subtitle' => __('Select the design style for the default page header', 'codeless'),
                        ...
                        array(
                            ...
                            'title' => __('Page Header with padding style title bg color', 'codeless'),
                            'mode' => 'background-color',
                            'type' => 'color_rgba',
                            'default'  => array(
                                'color' => '#000', 
                        ...
                        array(
                            ...
                            'title' => __('Page Header with padding style subtitle bg color', 'codeless'),
                            'mode' => 'background-color',
                            'type' => 'color_rgba',
                            'default'  => array(
                                'color' => '#fff', 
                        ...
                        array(
                            ...
                            'title' => __('Page Header with padding style subtitle font color', 'codeless'),
                            'mode' => 'color',
                            'type' => 'color',
                            'default'  => '#222',
                            'required' => array('page_header_design_style', 'equals', 'padd'),
             ...
             Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-adjust-alt',
                'title' => __('Footer Styling', 'codeless'),
                'fields' => array(
                    array( 
                        'id' => 'fppter_headings_typography',
                        'type' => 'typography',
                        'title' => __('Footer Headings Typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array(
                        ...
                        'title' => __('Footer Body Font Color', 'codeless'),
                        'subtitle' => __('Select the font color for text in footer' ,  'codeless'),
                        'default' => '#818181',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'title' => __('Footer links font Color', 'codeless'),
                        'subtitle' => __('Select the font color for links' ,  'codeless'),
                        'default' => '#cdcdcd',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'title' => __('Footer Background Color', 'codeless'),
                        'subtitle' => __('Color for the footer main part' ,  'codeless'), 
                        'mode' => 'background-color',
                        'default' => '#1c1c1c',
                        'validate' => 'color',
                    ),
                    array(
                        ...
                        'title' => __('Copyright Background Color', 'codeless'),
                        'subtitle' => __('Color for the latest part of the footer' ,  'codeless'), 
                        'mode' => 'background-color',
                        'default' => '#222222',
                        'validate' => 'color',
                    ),
                    ...
                    array( 
                        ...
                        'type'     => 'border',
                        'title'    => __('Footer Border Top', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        ...
                        'color'    => true,
                        'style'    => true, 
                        'desc'     => __('Add Border top for footer', 'codeless'),
                        'default'  => array(
                            'color'  => '', 
                            'border-style'  => 'solid',
                            'border-top'    => '0px'
                    ...
                    array(
                        ...
                        'title' => __('Social Icons Circle BG', 'codeless'),
                        'subtitle' => __('Circle background color' ,  'codeless'),
                        'default' => '#222222',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'title' => __('Social Icons Circle Icon Color', 'codeless'),
                        'subtitle' => __('Circle icon color' ,  'codeless'),
                        'default' => '#ffffff',
                        'validate' => 'color',
                    ),
            ...
            Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-adjust-alt',
                'title' => __('Blog Styling', 'codeless'),
                'fields' => array(
                    array( 
                        'id' => 'blog_title_typography',
                        'type' => 'typography',
                        'title' => __('Blog Title Typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Blog Info List Typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Blog Info List Icon Size', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => __('Active Timeline (or for masonry) Box Shadow', 'codeless'),
                        "default" => 1,
                    ),
                    array(
                        ...
                        'title' => __('Timeline (or masonry) post box bg color', 'codeless'),
                        'mode' => 'background-color',
                        'default' => '#ffffff',
                        'validate' => 'color',
                    ),
                    array(
                        ...
                        'title' => __('Fullscreen Blog Content Box BG', 'codeless'),
                        'mode' => 'background-color',
                        'type' => 'color_rgba',
                        'default'  => array(
                            'color' => '#ffffff', 
            ...
            Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-adjust-alt',
                'title' => __('Sidebar Styling', 'codeless'),
                'fields' => array(
                    array( 
                        'id' => 'sidebar_widget_title',
                        'type' => 'typography',
                        'title' => __('Widget Title', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array(
                        ...
                        //'units_extended' => 'true', // Allow users to select any type of unit
                        //'display_units' => 'false', // Set to false to hide the units if the units are specified
                        'title' => __('Widget Title Margin Bottom', 'codeless'),
                        'desc' => __('Unit: px', 'codeless'),
                    ...
                    array(
                        ...
                        //'units_extended' => 'true', // Allow users to select any type of unit
                        //'display_units' => 'false', // Set to false to hide the units if the units are specified
                        'title' => __('Widget Margin Bottom', 'codeless'),
                        'desc' => __('Unit: px', 'codeless'),
                    ...
                    array(
                        ...
                        'title' => __('Sidebar Tagcloud Background', 'codeless'),
                        'mode' => 'background-color',
                        'default' => '#222',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'output' => array('aside .tagcloud a'),
                        'title' => __('Sidebar Tagcloud Font color', 'codeless'),
                        'mode' => 'color',
                        'default' => '#fff',
                        'validate' => 'color',
                    )
            ...
            Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-adjust-alt',
                'title' => __('Sliders Styling', 'codeless'),
                'fields' => array(
                    array(
                        'id' => 'codeless_slider_wrapper_bg',
                        'type' => 'color',
                        'output' => array('.codeless_slider_wrapper'),
                        'title' => __('Codeless Slider Wrapper Background Color', 'codeless'),
                        'mode' => 'background-color',
                        'default' => '#222',
                        'validate' => 'color'
                    ),
            ...
            Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-adjust-alt',
                'title' => __('Filters Styling', 'codeless'),
                'fields' => array(
                    array( 
                        'id' => 'portfolio_filter_basic_typography',
                        'type' => 'typography',
                        'title' => __('Portfolio Filter & FAQ Filter Basic Typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>false,
                    ...
                    array(
                        ...
                        'title' => __('Portfolio Filter & FAQ Filter Basic Typography (Active)', 'codeless'),
                        'mode' => 'color',
                        'default' => '#222',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'title' => __('Portfolio Filter Fullwidth Background Color', 'codeless'),
                        'mode' => 'background-color',
                        'default' => '#222',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'title' => __('Portfolio Filter Fullwidth Item color', 'codeless'),
                        'mode' => 'color',
                        'default'  => array(
                            'color' => '#ffffff', 
                            'alpha' => '0.80'
                    ...
                    array(
                        ...
                        'title' => __('Portfolio Filter Fullwidth Item hover color ', 'codeless'),
                        'mode' => 'color',
                        'default'  => array(
                            'color' => '#ffffff', 
                            'alpha' => '1.00'
            ...
            Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-adjust-alt',
                'title' => __('Portfolio Styling', 'codeless'),
                'fields' => array(
                    array(
                        'id' => 'portfolio_overlay_bg',
                        'type' => 'color_rgba',
                        'output' => array('.portfolio-item.overlayed .tpl2 .bg'),
                        'title' => __('Portfolio Overlay BG Color ', 'codeless'),
                        'mode' => 'background-color',
                        'default'  => array(
                            'color' => '#10b8c7',  
                            'alpha' => '0.90'
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Portfolio Overlay Title Typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>false,
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Portfolio Overlay Subtitle Typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array(
                        ...
                        'title' => __('Portfolio Grayscale Background', 'codeless'),
                        'mode' => 'background-color',
                        'default' => '#fff',
                        'validate' => 'color',
                    ),
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Portfolio Grayscale Title Typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>false,
                    ...
                    array(
                        ...
                        'title' => __('Portfolio Grayscale Subtitle Color', 'codeless'),
                        'mode' => 'color',
                        'default' => '#bebebe',
                        'validate' => 'color',
                    ),
                    ...
                    array(
                        ...
                        'title' => __('Portfolio Basic Overlay Background', 'codeless'),
                        'mode' => 'background-color',
                        'default' => array(
                            'color' => '#fff',
                            'alpha' => '0.90'
                    ...
                    array(
                        ...
                        'title' => __('Portfolio Basic Icon Color', 'codeless'),
                        'mode' => 'color',
                        'default' => '#fff',
                        'validate' => 'color',
                    ),
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Portfolio Basic Title Typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>false,
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Portfolio Basic Subtitle Typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>false,
            ...
            Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-adjust-alt',
                'title' => __('Elements Styling', 'codeless'),
                'fields' => array(
                    array( 
                        'id' => 'toggle_title_typography',
                        'type' => 'typography',
                        'title' => __('Toggle title typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array(
                        ...
                        'title' => __('Activated Toggle Font Color', 'codeless'),
                        'mode' => 'color',
                        'default' => '#222',
                        'validate' => 'color',
                    ),
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Block Title Element (Column) Title', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>false,
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Block Title Element (Column) Subtitle', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>false,
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Block Title Element (Section) Title', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>false,
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Block Title Element (Section) Desc', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Animated Counters Typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array( 
                        'id' => 'testimonial_text',
                        'type' => 'typography',
                        'title' => __('Testimonial typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Textbar title typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'output' => '',
                        'title' => __('Contact Form Elements Border', 'codeless'),
                        'default' => 'transparent',
                        'validate' => 'color',
                    )
                ),
            ...
            Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-adjust-alt',
                'title' => __('Buttons Styling', 'codeless'),
                'fields' => array(
                    array(
                        ...
                        'title'    => __('Overall Button Style', 'codeless')
                    ),
                    ...
                    array( 
                        ...
                        'type' => 'typography',
                        'title' => __('Overall button typography', 'codeless'),
                        'font-family' => false,
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-size'=>true,
                    ...
                    array(
                        ...
                        'type' => 'color_rgba',
                        'output' => '',
                        'title' => __('Overall button background', 'codeless'),
                        'default'  => array(
                            'color' => '#ffffff',  
                            'alpha' => '0.00'
                        ),
                    ...
                    array(
                        ...
                        'type' => 'color_rgba',
                        'output' => '',
                        'title' => __('Overall button border', 'codeless'),
                        'default'  => array(
                            'color' => '#444444', 
                            'alpha' => '0.20'
                        ),
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'output' => '',
                        'title' => __('Overall button hover Font Color', 'codeless'),
                        'default' => '#222',
                        'validate' => 'color'
                    ),
                    ...
                    array(
                        ...
                        'type' => 'color_rgba',
                        'output' => '',
                        'title' => __('Overall button hover bg', 'codeless'),
                        'default'  => array(
                            'color' => '#ffffff', 
                            'alpha' => '0.00'
                        ),
                    ...
                    array(
                        ...
                        'type' => 'color_rgba',
                        'output' => '',
                        'title' => __('Overall button hover border', 'codeless'),
                        'default'  => array(
                            'color' => '#444', 
                            'alpha' => '1.00'
                        ),
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'output' => '',
                        'title' => __('Light button Font Color', 'codeless'),
                        'default' => '#fff',
                        'validate' => 'color'
                    ),
                    ...
                    array(
                        ...
                        'type' => 'color_rgba',
                        'output' => '',
                        'title' => __('Light button bg', 'codeless'),
                        'default'  => array(
                            'color' => '#fff', 
                            'alpha' => '0.00'
                        ),
                    ...
                    array(
                        ...
                        'type' => 'color_rgba',
                        'output' => '',
                        'title' => __('Light button border', 'codeless'),
                        'default'  => array(
                            'color' => '#fff', 
                            'alpha' => '0.40'
                        ),
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'output' => '',
                        'title' => __('Light button hover Font Color', 'codeless'),
                        'default' => '#fff',
                        'validate' => 'color'
                    ),
                    ...
                    array(
                        ...
                        'type' => 'color_rgba',
                        'output' => '',
                        'title' => __('Light button hover bg', 'codeless'),
                        'default'  => array(
                            'color' => '#fff', 
                            'alpha' => '0.00'
                        ),
                    ...
                    array(
                        ...
                        'type' => 'color_rgba',
                        'output' => '',
                        'title' => __('Light button hover border', 'codeless'),
                        'default'  => array(
                            'color' => '#fff', 
                            'alpha' => '1.00'
                        ),
            ...
            Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-adjust-alt',
                'title' => __('Shop Styling', 'codeless'),
                'fields' => array(
                    
                    array(
                        'id' => 'shop_single_title',
                        'type' => 'typography',
                        'title' => __('Shop Single Product Title', 'codeless'),
                        ...
                        'units' => 'px',
                        'subtitle' => __('Select the appropiate font style for single product title', 'codeless'),
                        'default' => array(
                            'font-weight' => '700',
                            'letter-spacing' => '1.5',
                            'text-transform' => 'uppercase'
                    ...
                    array(
                        ...
                        'type' => 'color_rgba',
                        'title' => __('Shop item overlay', 'codeless'),
                        'mode' => 'background-color', 
                        'default'  => array(
                            'color' => '#10b8c7', 
                            'alpha' => '0.90'
            ...
            Redux::setSection( $opt_name, array(
                ...
                'title' => __('Typography Options', 'codeless'),
                'fields' => array(
                    array(
                        'id' => 'body_typography',
                        'type' => 'typography',
                        'title' => __('Body Font Style', 'codeless'),
                        'compiler'=>false, 
                        'google' => true, 
                        'font-backup' => true,
                        'font-style'=>true, 
                        ...
                        'output' => array('body'), 
                        'units' => 'px',
                        'subtitle' => __('Select the appropiate font style for the body text', 'codeless'),
                        'default' => array(
                            'color' => "#777",
                            'font-family' => 'Open Sans',
                            'google' => true,
                    ...
                    array(
                        ...
                        'type' => 'typography',
                        'title' => __('Headings font type', 'codeless'),
                        'google' => true, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-weight' => true,
                        'font-style' => true,
                    ...
                    array(
                        'id' => 'heading_1_font',
                        'type' => 'typography',
                        'title' => __('Heading 1 Font style', 'codeless'),
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-weight' => false,
                        'font-style' => false,
                        ...
                        'output' => array('h1'), 
                        'units' => 'px',
                        'subtitle' => __('Select the appropiate font style for the h1 text', 'codeless'),
                        'default' => array(
                            'line-height' => '24px',
                            'google' => true,
                            'font-size' => '20px'
                    ...
                    array(
                        'id' => 'heading_2_font',
                        'type' => 'typography',
                        'title' => __('Heading 2 Font style', 'codeless'),
                        //'compiler'=>true, // Use if you want to hook in your own CSS compiler
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-weight' => false,
                        ...
                        'output' => array('h2'), 
                        'units' => 'px',
                        'subtitle' => __('Select the appropiate font style for this heading', 'codeless'),
                        'default' => array(
                            'line-height' => '30px',
                            'google' => true,
                            'font-size' => '24px'
                    ...
                    array(
                        'id' => 'heading_3_font',
                        'type' => 'typography',
                        'title' => __('Heading 3 Font style', 'codeless'),
                        //'compiler'=>true, // Use if you want to hook in your own CSS compiler
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-weight' => false,
                    ...
                    array(
                        'id' => 'heading_4_font',
                        'type' => 'typography',
                        'title' => __('Heading 4 Font style', 'codeless'),
                        //'compiler'=>true, // Use if you want to hook in your own CSS compiler
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-weight' => false,
                    ...
                    array(
                        'id' => 'heading_5_font',
                        'type' => 'typography',
                        'title' => __('Heading 5 Font style', 'codeless'),
                        //'compiler'=>true, // Use if you want to hook in your own CSS compiler
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-weight' => false,
                    ...
                    array(
                        'id' => 'heading_6_font',
                        'type' => 'typography',
                        'title' => __('Heading 6 Font style', 'codeless'),
                        //'compiler'=>true, // Use if you want to hook in your own CSS compiler
                        'google' => false, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => false, // Select a backup non-google font in addition to a google font
                        'font-weight' => false,
            ...
            Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-adjust-alt',
                'title' => __('Footer Options', 'codeless'),
                'fields' => array(
                    array(
                        'id'       => 'footer_columns',
                        'type'     => 'image_select',
                        'title'    => __('Footer Columns', 'codeless'), 
                        'subtitle' => __('Select how many columns do you want for the footer. Choose between 1, 2, 3 or 4 column layout.', 'codeless'),
                        'options'  => array(
                            '1'      => array(
                                'alt'   => '1 Column', 
                    ...
                    array(
                        'id' => 'copyright_text',
                        'type' => 'editor',
                        'title' => __('Copyright Text in the end of footer', 'codeless'),
                        'subtitle' => __('Text have to be placed in the copyright bar', 'codeless'),
                    ...
                    array(
                        'id' => 'show_copyright',
                        'type' => 'switch',
                        'title' => __('Show Copyright', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        "default" => 1,
                    ),
            ...
            Redux::setSection( $opt_name, array(
                ...
                'title' => __('Blog Config', 'codeless'),
                'fields' => array(
                    array(
                        'id' => 'blog_style',
                        'type' => 'select',
                        'title' => __('Blog Style', 'codeless'),
                        'subtitle' => __('Select the blog style to be used', 'codeless'),
                    ...
                    array(
                        'title'     => __( 'Layout', 'codeless' ),
                        'desc'      => __( 'Select main content and sidebar arrangement.', 'codeless' ),
                        'id'        => 'bloglayout',
                        'default'   => 'fullwidth',
                        'type'      => 'image_select',
                        'customizer'=> array(),
                    ...
                    array(
                        'title'     => __( 'Single Post Layout', 'codeless' ),
                        'desc'      => __( 'Select the default single post sidebar position', 'codeless' ),
                        'id'        => 'singlebloglayout',
                    ...
                    array(
                        'id' => 'post_like',
                        'type' => 'switch',
                        'title' => __('Active Post Like', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        "default" => 1,
                    ),
                    ...
                    array(
                        'id' => 'social_shares',
                        'type' => 'switch',
                        'title' => __('Social Shares on Posts', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        "default" => 0,
                    ),
                    ...
                    array(
                        'id' => 'blog_pagination',
                        'type' => 'select',
                        'title' => __('Select the pagination method', 'codeless'),
                    ...
                    array(
                        'id' => 'blog_info_author',
                        'type' => 'switch',
                        'title' => __('Show author at blog post', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        "default" => 1,
                    ),
                    array(
                        'id' => 'blog_info_date',
                        'type' => 'switch',
                        'title' => __('Show date at blog post', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        "default" => 1,
                    ),
                    array(
                        ...
                        'type' => 'switch',
                        'title' => __('Show comments count at blog post', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        "default" => 1,
                    ),
                    array(
                        'id' => 'blog_info_tags',
                        'type' => 'switch',
                        'title' => __('Show tags at blog post', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        "default" => 1,
                    ),
            ...
            Redux::setSection( $opt_name, array(
                ...
                'title' => __('Portfolio Config', 'codeless'),
                'fields' => array(
                    array(
                        'id' => 'portfolio_slug',
                        'type' => 'text',
                        'title' => __('Portfolio Slug', 'codeless'),
                        'default' => 'codeless_portfolio'
                    ),
                    array(
                        'id'=>'single_portfolio_custom_params',
                        'type' => 'multi_text',
                        'title' => __('Custom fields Parameters', 'codeless'),
                        'subtitle' => __('Create unlimited custom fields. Add values in respetive single portfolio', 'codeless') 
                    ),
                    array(
                        'id' => 'portfolio_post_like',
                        'type' => 'switch',
                        'title' => __('Active Portfolio Item Like', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        "default" => 0,
                    ),
                )
            ...
            Redux::setSection( $opt_name, array(
                ...
                'fields' => array(
                    array(
                        'id' => 'site_layout',
                        'type' => 'select',
                        'title' => __('Overall site layout', 'codeless'),
                        'subtitle' => __('Select overall ste pages layout', 'codeless'),
                        'options' => array('fullwidth' => 'Fullwidth', 'boxed' => 'Boxed'), //Must provide key => value pairs for select options
                        'default' => 'fullwidth'
                    ),

                    array(
                        'title'     => __( 'Pages Default Layout', 'codeless' ),
                        'desc'      => __( 'Select default layout for pages. You can overwrite it in Page Options', 'codeless' ),
                    ...
                    array(
                        ...
                        'width' => true,
                        'height' => false,
                        'title' => __('Page Container Width', 'codeless'),
                        'subtitle' => __('units: px', 'codeless'),
                        'desc' => __('', 'codeless'),
                    ...
                    array(
                        ...
                        'width' => true,
                        'height' => false,
                        'title' => __('Page Container Width with percentage', 'codeless'),
                        'subtitle' => __('units: px', 'codeless'),
                        'desc' => __('If you set the width in percentage, the page container width in pixel should be used as max-width', 'codeless'),
                    ...
                    array(
                        ...
                        'width' => true,
                        'height' => false,
                        'title' => __('Boxed Container Width', 'codeless'),
                        'subtitle' => __('units: px', 'codeless'),
                        'desc' => __('', 'codeless'),
                    ...
                    array(
                        ...
                        'width' => true,
                        'height' => false,
                        'title' => __('Boxed Container Width with percentage', 'codeless'),
                        'subtitle' => __('units: px', 'codeless'),   
                        'required' => array('site_layout', 'equals', 'boxed'),
                        'desc' => __('If you set the width in percentage, the boxed container width in pixel should be used as max-width', 'codeless'),
                        'default' => array('width' => '87%')
                    ),

                    array(
                        'title'=> __( 'Boxed Container Margin', 'codeless' ),
                        'desc' => __( 'Boxed Container Top/Bottom Margin', 'codeless' ),
                    ...
                    array(
                        'id' => 'boxed_shadow',
                        'type' => 'switch',
                        'title' => __('Boxed Container Shadow', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        'required' => array('site_layout', 'equals', 'boxed'),
                        "default" => 1,
                    ),
                    ...
                    array(
                        'id'       => 'boxed_border',
                        'type'     => 'border',
                        'title'    => __('Boxed Container Border', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        ...
                        'style'    => true, 
                        'required' => array('site_layout', 'equals', 'boxed'),
                        'desc'     => __('Add Border for boxed container', 'codeless'),
                        'default'  => array(
                            'color'  => '#e7e7e7', 
                            'border-style'  => 'solid',
                            'border'    => '0px'
                    ...
                    array(
                        'id' => 'extra_navigation',
                        'type' => 'switch',
                        'title' => __('Extra Side Navigation', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        "default" => 1,
                    ),

                    array(
                        'title'     => __( 'Extra Navigation Position', 'codeless' ),
                        'desc'      => __( 'Select the default single post sidebar position', 'codeless' ),
                    ...
                    array(
                        'title'=> __( 'Page Builder Row Margin Bottom', 'codeless' ),
                        'desc' => __( 'Margin bottom for the ROW in Page builder', 'codeless' ),
                    ...
                    array(
                        'title'=> __( 'Inner Page Content Padding', 'codeless' ),
                        'desc' => __( 'Change padding of the inner page content', 'codeless' ),
                        'id'   => 'content_padding',
                        'type' => 'spacing',
                        'output' => array('#content'), 
                        'mode' => 'padding', // absolute, padding, margin, defaults to padding
            ...
            Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-heart',
                'title' => __('Clients', 'codeless'),
                'fields' => array(
                    array(
                        'id'       => 'clients_dark',
                        'type'     => 'slides',
                        'title'    => __('Add/Edit Clients Dark Version', 'codeless'),
                        'subtitle' => __('Upload clients logo here', 'codeless')
                    ),

                    array(
                        'id'       => 'clients_light',
                        'type'     => 'slides',
                        'title'    => __('Add/Edit Clients Light Version', 'codeless'),
                        'subtitle' => __('Upload clients logo here', 'codeless')
                    ),
            ...
            Redux::setSection( $opt_name, array(
                'icon' => 'el-icon-twitter',
                'title' => __('Social Media', 'codeless'),
                'fields' => array(
                    array(
                        'id'       => 'facebook',
                        'type'     => 'text',
                    ...
                    array(
                        'id'       => 'flickr',
                        'type'     => 'text',
                        'title'    => __('Flickr Link', 'codeless')
                    ),
                    array(
                        'id'       => 'foursquare',
                        'type'     => 'text',
                        'title'    => __('Foursquare Link', 'codeless')
                    ),
                    array(
                        'id'       => 'google',
                        'type'     => 'text',
                        'title'    => __('Google Plus Link', 'codeless')
                    ),
                    array(
                        'id'       => 'dribbble',
                        'type'     => 'text',
                        'title'    => __('Dribbble Link', 'codeless')
                    ),
                    array(
                        'id'       => 'linkedin',
                        'type'     => 'text',
                    ...
                    array(
                        'id'       => 'youtube',
                        'type'     => 'text',
                        'title'    => __('Youtube Link', 'codeless')
                    ),
                    ...
                    array(
                        'id'       => 'snapchat',
                        'type'     => 'text',
                        'title'    => __('Snapchat Link', 'codeless')
                    ),

                    array(
                        'id'       => 'vimeo',
                        'type'     => 'text',
                        'title'    => __('Vimeo Link', 'codeless')
                    ),

                    array(
                        'id'       => 'email',
                        'type'     => 'text',
                        'title'    => __('Email Link', 'codeless')
                    ),
                )
            ));
            ...
            Redux::setSection( $opt_name, array( 
                ...
                'title' => __('Custom Sidebars', 'codeless'),
                'fields' => array(
                    array(
                        'id'       => 'pages_sidebar',
                        'type'     => 'select',
                        'multi'    => true,
                        'data'     => 'pages',
                        'title'    => __('Pages custom sidebars', 'codeless'),
                        'subtitle' => __('Select all pages that you want a custom sidebar (widgetized area)', 'codeless')
                    ),
                    ...
                    array(
                        ...
                        'multi'    => true,
                        'data'     => 'categories',
                        'title'    => __('Categories custom sidebars', 'codeless'),
                        'subtitle' => __('Select all categories that you want a custom sidebar (widgetized area)', 'codeless')
                    ),
            ...
            Redux::setSection( $opt_name, array( 
                'icon' => 'el-icon-magic',
                'title' => __('Import / Export (Dummy Data)', 'codeless'),
                'fields' => array(
                    array(
                        'id'       => 'codeless_import_export',
                        'type'     => 'codeless_import', 
                        'data'     => array(
                            array('name' => 'Default', 'image' => CODELESS_BASE_URL . 'includes/dummy_data/img/default.jpg', 'folder' => 'default', 'parts' => '1'),
                        ...
                        'title'    => __('Codeless Import', 'codeless'),
                        'subtitle' => __('', 'codeless'),
                        'default' => 'default'
                    )
                )
            ...
            if (file_exists(trailingslashit(dirname(__FILE__)) . 'README.html')) {
                $tabs['docs'] = array(
                    'icon' => 'el-icon-book',
                    'title' => __('Documentation', 'codeless'),
