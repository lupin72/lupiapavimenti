...
if ( !function_exists( "cl_add_codeless_slider_metaboxes" ) ):
    function cl_add_codeless_slider_metaboxes($metaboxes) {
        ...
        $slide_background = array(
            ...
            'fields'        => array(
                array(
                    ...
                    'title' => __( 'Background Type', 'codeless' ),
                ...
                array(
                    ...
                    'type' => 'background',
                    'title' => __('Background Image / Color', 'codeless'),
                    'subtitle' => __('Page Header background with image', 'codeless'),
                    'default' => '',
                ...
                array(
                    'id' => 'slide_mp4_video',
                    'type' => 'text',
                    'title' => __('MP4 video Url', 'codeless'),
                    'default' => '',
                ...
                array(
                    'id' => 'slide_webm_video',
                    'type' => 'text',
                    'title' => __('Webm video Url', 'codeless'),
                    'default' => '',
                    'required' => array('slide_background_type','=','video'),
                ), 
                ...
                array(
                    'id' => 'slide_ogg_video',
                    'type' => 'text',
                    'title' => __('OGG video Url', 'codeless'),
                    'default' => '',
                    'required' => array('slide_background_type','=','video'),
                ), 
                ...
                array(
                    ...
                    'type' => 'media',
                    'title' => __('Image to replace video on mobile', 'codeless'),
                    'default' => '',
                    'required' => array('slide_background_type','=','video'),
                ), 
                ...
                array(
                    'id'=>'slide_bg_overlay',
                    'type' => 'color_rgba', 
                    'title' => __('Background Color Overlay', 'codeless'),
                    'subtitle'=> __('Use a bg overlay', 'codeless'),
                    'default'  => array(
                        'color' => '', 
                        'alpha' => '1.0'
                    )
        ...
        $slide_content = array(
            ...
            'fields'        => array(
                ...
                array(
                    'id' => 'slide_title',
                    'type' => 'textarea',
                    'title' => __('Title', 'codeless')
                ),

                array(
                    'id'          => 'slide_title_style',
                    'type'        => 'typography', 
                    'title'       => __('Title Style', 'codeless'),
                    'google'      => true, 
                    'font-backup' => false,
                    'font-style'  => false,
                    'text-transform' => true,
                ...
                array(
                        'id' => 'slide_title_bg',
                        'type' => 'color_rgba',
                        'title' => __('Title Background', 'codeless'),
                ...
                array(
                    ...
                    'title' => __('Title Padding', 'codeless'),
                ...
                array(
                    ...
                    'title' => __( 'Title animation', 'codeless' ),
                ...
                array(
                    ...
                    'type' => 'textarea',
                    'title' => __('Description', 'codeless')
                ),

                array(
                    'id'          => 'slide_description_style',
                    'type'        => 'typography', 
                    'title'       => __('Description Style', 'codeless'),
                    'google'      => true, 
                    'font-backup' => false,
                    'font-style'  => false,
                    'text-transform' => true,
                ...
                array(
                    ...
                    'title' => __( 'Description animation', 'codeless' ),
                    'desc' => 'Select type of animation',
                    'type' => 'select',
                ...
                array(
                    ...
                    'type' => 'switch',
                    'title' => __('Image On Top', 'codeless'),
                    'subtitle' => __('Add an image on top of texts', 'codeless'),
                    "default" => 0
                ),
                ...
                array(
                    ...
                    'type'     => 'media', 
                    'url'      => true,
                    'title'    => __('Image Media w/ URL', 'codeless'),
                    'default'  => array(
                        'url'=>''
                    ),
                ...
                array(
                    ...
                    'title' => __( 'Image Alignment', 'codeless' ),
                ...
                array(
                    ...
                    'type'     => 'dimensions',
                    'units'    => array('px'),
                    'title'    => __('Image Dimensions (Width/Height)', 'codeless'),
                    'default'  => array(
                        'Width'   => '200', 
                        'Height'  => '100'
                    ),
                ...
                array(
                    'id' => 'slide_button1',
                    'type' => 'text',
                    'title' => __('Button Label', 'codeless'),
                ...
                array(
                    ...
                    'type' => 'text',
                    'title' => __('Button Link', 'codeless')
                ),

                array(
                    'id' => 'slide_button1_style',
                    'title' => __( 'Button Style', 'codeless' ),
                ...
                array(
                    ...
                    'title' => __( 'Overall Buttons Colors', 'codeless' ),
        ...
        $slide_layout = array(
            ...
            'fields'        => array(
                 ...
                 array(
                    ...
                    'title'          => __('Content custom absolute position', 'codeless'),
                    'subtitle'       => __('Add absolute positioning', 'codeless'),
                ...
                array(
                    ...
                    'type' => 'text',
                    'title' => __('Content Width', 'codeless'),
                ...
                array(
                    'id' => 'remove_container',
                    'type' => 'switch',
                    'title' => __('Remove Site Container from slider', 'codeless'),
                    'subtitle' => __('By switching this you can remove the slider container and the content should be shown from the left to the right of the screen.', 'codeless'),
                    "default" => 0,
                ),
                ...
                array(
                    ...
                    'type' => 'select', 
                    'title' => __('Menu & Slider Navigation Color', 'codeless'),
                    'subtitle' => __('Select Light for light colors in header, white logo and light slider nav', 'codeless'),
        ...
        $metaboxes[] = array(
            'id'            => 'codeless-slider',
            'title'         => __( 'Codeless Slide Options', 'codeless' ),
