...
<div class="cart">
		...
		<div class="content">
			...
			<div class="checkout">
                ...
                <div class="view_cart  <?php echo esc_attr($cl_redata['cart_dropdown_button']) ?>"><a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="btn-bt <?php echo esc_attr($cl_redata['overall_button_style'][0]) ?>"><?php _e('View Cart', 'codeless'); ?></a></div>
