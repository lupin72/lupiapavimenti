            ...
            <div class="wrap about-wrap">
                ...
                <div class="changelog">
                    ...
                    <div class="feature-section">
                        ...
                        <p><?php _e( 'We do our best to provide the best support we can. If you encounter a problem or have a question, post a question in the', 'redux-framework' ); ?></p>

                        <h4><?php _e( 'Need Even Faster Support?', 'redux-framework' ); ?></h4>

                        <p><?php _e( 'Our  are there for customers that need faster and/or more in-depth assistance.', 'redux-framework' ); ?></p>
                ...
                <div class="changelog">
                    ...
                    <div class="feature-section">
                        ...
                        <p><?php _e( 'New extensions that make Easy Digital Downloads even more powerful are released nearly every single week. Subscribe to the newsletter to stay up to date with our latest releases', 'redux-framework' ); ?></p>

                        <h4><?php _e( 'Get Alerted About New Tutorials', 'redux-framework' ); ?></h4>

                        <p><?php _e( 'To hear about the latest tutorial releases that explain how to take Easy Digital Downloads further.', 'redux-framework' ); ?></p>
                ...
                <div class="changelog">
                    ...
                    <div class="feature-section">
                        ...
                        <p><?php _e( 'has a list of all available extensions, including convenient category filters so you can find exactly what you are looking for.', 'redux-framework' ); ?></p>
