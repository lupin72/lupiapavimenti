<div class="wrap about-wrap">
    <h1><?php printf( __( 'Welcome to Redux Framework %s', 'codeless' ), $this->display_version ); ?></h1>

    <div
        class="about-text"><?php printf( __( 'Thank you for updating to the latest version! Redux Framework %s is a huge step forward in Redux Development. Look at all that\'s new.', 'codeless' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
            class="el el-redux"></i><span><?php printf( __( 'Version %s', 'codeless' ), ReduxFramework::$_version ); ?></span>
    </div>
                ...
                <div>
                    ...
                    <p>This version the fastest Redux ever released. We've integrated ajax_saving as well as many other
                        speed improvements to make Redux even surpass the load time of <a
                            href="#" target="_blank">SMOF</a> even with
                        large panels.</p>
                </div>
                <div>
