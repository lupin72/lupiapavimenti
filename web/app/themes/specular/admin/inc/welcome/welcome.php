<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
            echo __( 'If you like <strong>Redux</strong> please leave us a <a href="https://wordpress.org/support/view/plugin-reviews/redux-framework?filter=5#postform" target="_blank" class="redux-rating-link" data-rated="Thanks :)">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. A huge thank you from Redux in advance!', 'codeless' );
        }
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = esc_html__( "Support hash could not be generated. Please try again later.", 'codeless' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            $page(
                esc_html__( 'Welcome to Redux Framework', 'codeless' ), esc_html__( 'Redux Framework', 'codeless' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            $page(
                esc_html__( 'Redux Framework Changelog', 'codeless' ), esc_html__( 'Redux Framework Changelog', 'codeless' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Get Support', 'codeless' ), esc_html__( 'Get Support', 'codeless' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Redux Extensions', 'codeless' ), esc_html__( 'Redux Extensions', 'codeless' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            $page(
                esc_html__( 'The people that develop Redux Framework', 'codeless' ), esc_html__( 'The people that develop Redux Framework', 'codeless' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            $page(
                esc_html__( 'Redux Framework Status', 'codeless' ), esc_html__( 'Redux Framework Status', 'codeless' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
        ...
        public function tabs() {
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo $selected == 'redux-about' ? 'nav-tab-active' : ''; ?>"
                    ...
                    <?php esc_attr_e( "What's New", 'codeless' ); ?>
                    ...
                    <?php esc_attr_e( 'Extensions', 'codeless' ); ?>
                    ...
                    <?php esc_attr_e( 'Changelog', 'codeless' ); ?>
                    ...
                    <?php esc_attr_e( 'Support', 'codeless' ); ?>
                    ...
                    <?php esc_attr_e( 'Status', 'codeless' ); ?>
                </a>
            </h2>
            <?php
        }
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'codeless' ), esc_html( $contributor->login ) ) )
                );
