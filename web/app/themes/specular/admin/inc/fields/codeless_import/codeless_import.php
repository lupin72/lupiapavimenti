...
if( !class_exists( 'ReduxFramework_codeless_import' ) ) {
    ...
    class ReduxFramework_codeless_import {
        ...
        function render() {
            ...
            echo '<p><a href="#" id="import-data" name="import_data" class="button-primary">Import</a><span>' . apply_filters( 'redux-import-warning', __( 'WARNING! This will overwrite all existing option values, please proceed with caution!', 'codeless' ) ) . '</span></p>';
