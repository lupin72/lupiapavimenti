...
if (!class_exists('ReduxFramework_group')) {
    ...
    class ReduxFramework_group {
        ...
        public function render() {
            ...
            echo '<div class="redux-groups-accordion-group redux-dummy" style="display:none" id="redux-dummy-' . $this->field['id'] . '"><h3><span class="redux-groups-header">' . __("New ", "codeless") . $this->field['groupname'] . '</span></h3>';
            ...
            //$field_is_title = true;
                ...
                echo '</table>';
                echo '<a href="javascript:void(0);" class="button deletion redux-groups-remove">' . __('Delete', 'codeless').' '. $this->field['groupname']. '</a>';
                echo '</div></div>';


            echo '</div><a href="javascript:void(0);" class="button redux-groups-add button-primary" rel-id="' . $this->field['id'] . '-ul" rel-name="' . $this->parent->args['opt_name'] . '[' . $this->field['id'] . '][slide_title][]">' . __('Add', 'codeless') .' '.$this->field['groupname']. '</a><br/>';
